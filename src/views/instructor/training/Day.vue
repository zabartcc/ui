				...
				<tbody class="requests_list_row">
					<tr v-for="(request, i) in requests" :key="request._id">
						...
						<td class="options">
							...
							<a :href="`#modal_delete_${i}`" data-position="top" data-tooltip="Delete Request" class="tooltipped modal-trigger red-text text-darken-2" v-if="requiresAuth(['atm1', 'datm', 'ta', 'ins'])">

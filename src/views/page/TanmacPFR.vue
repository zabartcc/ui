<template>
	<div class="card">
		<div class="card-content">
			...
			<div class="card_desc">
				<p>
					Thank you for submitting a TANMAC PFR. The information you provided will be sent to the instructional staff and may be used in training.
				</p>
			</div>
			<div v-if="!user.isLoggedIn">
				<p>To prevent abuse of the system, all users need to log in via VATSIM before sending a PFR.</p><br />
				<div class="center-align">
					<button class="btn btn-waves login_button" @click="login">Login via VATSIM</button>
				</div>
			</div>
			<form class="row row_no_margin" id="pfr_form" @submit.prevent="submitPfr" v-else>
				<div class="input-field col s12 m6">
					<input id="name" type="text" class="validate" :value="pfr.name" disabled>
				...
				<div class="input-field col s12">
					<textarea id="deficiencies" class="materialize-textarea" data-length="5000" v-model="pfr.deficiencies" required></textarea>
					<label for="deficiencies">Deficiencies*</label>
				</div>
				<div class="input-field col s12">
					<textarea id="comments" class="materialize-textarea" data-length="5000" v-model="pfr.comments"></textarea>

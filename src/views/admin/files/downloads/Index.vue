<template>
	<div class="card" v-if=downloads>
		...
		<div class="table_wrapper">
			<div class="no_downloads" v-if="downloads.length == 0">There are no downloads to display.</div>
...
export default {
	...
	methods: {
		async getDownloads() {
			this.downloads = await this.getDownloadsMixin();
		},

		...
		<table class="event_list striped" v-else>
			...
			<tbody class="event_list_row">
				<tr v-for="(feedback, i) in unapproved" :key="feedback._id">
					...
					<td>{{feedback.controller.fname}} {{feedback.controller.lname}}</td>
					...
					<div :id="`modal_unapproved_${i}`" class="modal modal_unapproved">
						<div class="modal-content">
							<div class="modal_title">Unapproved Feedback for {{feedback.controller.fname}} {{feedback.controller.lname}}</div>
							<div class="feedback">
								<div class="submitter">

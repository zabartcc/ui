				...
				<div class="col s12 l6 pull-l6">
					<form class="row row_no_margin" @submit.prevent="submitRequest">
						<div class="input-field col s12">
							...
							<label for="start_date">Start Time (Local Time)<span class="red-text">*</span></label>
						</div>
						<div class="input-field col s12">
							<input id="end_date" type="text" ref="end_date" required>
							<label for="end_date">End Time (Local time)<span class="red-text">*</span></label>
						</div>
						<div class="input-field col s12">
...
export default {
	...
	async mounted() {
		...
		// change
		const today = new Date(new Date().toLocaleTime());
